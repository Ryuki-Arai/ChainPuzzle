...
public class DataSaveUtility : Singleton<DataSaveUtility>
{
    private SaveDataObject data;     // json変換するデータのクラス
    public SaveDataObject Data => data;
    ...
    filepath = Application.persistentDataPath + "/" + fileName;    
        ...
        {
            Debug.Log("データが存在しない");
            data = Resources.Load<SaveDataObject>(playerSaveDataObjectPath);
        }
        else
        {
            Debug.Log("データが存在する");
            ...
            var newData = new SaveDataObject();
